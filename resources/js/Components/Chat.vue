...
<template>
    <div class="h-full">
                                    ...
                                    >
                                        <div class="relative flex">
                                            <img
                                                ...
                                                data-nimg="1"
                                                class="rounded-sm"
                                                src="https://lh3.googleusercontent.com/a/AEdFTp4akbZbEuEZsS2GlDHq_1YCI9jR0Md1SP8hsvyBIA=s96-c"
                            ...
                            <div class="flex-col gap-1 md:gap-3">
                                <div class="flex flex-grow flex-col max-w-full">
                                    <div
                                        ...
                                        data-message-id="aaa242ea-8a19-4175-bad7-071039349d9b"
                                        dir="auto"
                                        class="min-h-[20px] text-message flex flex-col items-start whitespace-pre-wrap break-words [.text-message+&amp;]:mt-5 overflow-x-auto gap-3"
                                    >
                                        <div class="relative max-w-[90%]">
                                            custome textarea component in html
                                            and vue
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        >
                            <div>
                                <div class="pt-0.5">
                                    <div
                                        class="gizmo-bot-avatar flex h-6 w-6 items-center justify-center overflow-hidden rounded-full"
                                    >
                                        <div
                                            class="relative p-1 rounded-sm flex items-center justify-center bg-neutral-800 text-white h-6 w-6"
                                        >
                                            <svg
                                                width="41"
                                                height="41"
                        ...
                        <div class="relative flex w-full min-w-0 flex-col">
                            <div class="font-semibold select-none">Info Hero</div>
                            <div class="flex-col gap-1 md:gap-3">
                                <div class="flex flex-grow flex-col max-w-full">
                                    <div
                                        data-message-author-role="user"
        ...
        <div class="h-1/6">
            <div
                class="py-2 px-3 text-base md:px-4 m-auto lg:px-1 xl:px-5 h-full"
            >
                <div
                    class="mx-auto flex flex-1 gap-3 h-full text-base juice:gap-4 juice:md:gap-6 md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem]"
                >
